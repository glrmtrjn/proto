...
SC_MODULE(outmodule)
{
	...
	sc_in<sc_lv<constNumLane> > inlane_tx0;
	sc_in<sc_lv<constFlitSize> > indata0;
	sc_out<sc_lv<constNumLane> > outcredit0;
	sc_in<sc_logic> inclock1;
	sc_in<sc_logic> intx1;
	sc_in<sc_lv<constNumLane> > inlane_tx1;
	sc_in<sc_lv<constFlitSize> > indata1;
	sc_out<sc_lv<constNumLane> > outcredit1;
	sc_in<sc_logic> inclock2;
	sc_in<sc_logic> intx2;
	sc_in<sc_lv<constNumLane> > inlane_tx2;
	sc_in<sc_lv<constFlitSize> > indata2;
	sc_out<sc_lv<constNumLane> > outcredit2;
	sc_in<sc_logic> inclock3;
	sc_in<sc_logic> intx3;
	sc_in<sc_lv<constNumLane> > inlane_tx3;
	sc_in<sc_lv<constFlitSize> > indata3;
	sc_out<sc_lv<constNumLane> > outcredit3;
	sc_in<sc_logic> inclock4;
	sc_in<sc_logic> intx4;
	sc_in<sc_lv<constNumLane> > inlane_tx4;
	sc_in<sc_lv<constFlitSize> > indata4;
	sc_out<sc_lv<constNumLane> > outcredit4;
	sc_in<sc_logic> inclock5;
	sc_in<sc_logic> intx5;
	sc_in<sc_lv<constNumLane> > inlane_tx5;
	sc_in<sc_lv<constFlitSize> > indata5;
	sc_out<sc_lv<constNumLane> > outcredit5;
	...
	int inline inLaneTx(int Indice, int Lane){
		if(Indice == 0){
			if(Lane == 0) return (inlane_tx0.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx0.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
		if(Indice == 1){
			if(Lane == 0) return (inlane_tx1.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx1.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
		if(Indice == 2){
			if(Lane == 0) return (inlane_tx2.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx2.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
		if(Indice == 3){
			if(Lane == 0) return (inlane_tx3.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx3.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
		if(Indice == 4){
			if(Lane == 0) return (inlane_tx4.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx4.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
		if(Indice == 5){
			if(Lane == 0) return (inlane_tx5.read().get_bit(0) == SC_LOGIC_1)? 1 : 0;
			if(Lane == 1) return (inlane_tx5.read().get_bit(1) == SC_LOGIC_1)? 1 : 0;
		}
	...
	inclock0("inclock0"),
	intx0("intx0"),
	inlane_tx0("inlane_tx0"),
	indata0("indata0"),
	outcredit0("outcredit0"),
	inclock1("inclock1"),
	intx1("intx1"),
	inlane_tx1("inlane_tx1"),
	indata1("indata1"),
	outcredit1("outcredit1"),
	inclock2("inclock2"),
	intx2("intx2"),
	inlane_tx2("inlane_tx2"),
	indata2("indata2"),
	outcredit2("outcredit2"),
	inclock3("inclock3"),
	intx3("intx3"),
	inlane_tx3("inlane_tx3"),
	indata3("indata3"),
	outcredit3("outcredit3"),
	inclock4("inclock4"),
	intx4("intx4"),
	inlane_tx4("inlane_tx4"),
	indata4("indata4"),
	outcredit4("outcredit4"),
	inclock5("inclock5"),
	intx5("intx5"),
	inlane_tx5("inlane_tx5"),
	indata5("indata5"),
